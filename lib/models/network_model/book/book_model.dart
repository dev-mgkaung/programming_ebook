import 'package:meta/meta.dart';
 ...
 BookList booklist = BookList(books: [
  ...
  Book(
      ...
      price: 13.49,
      summary:
      "Without the guidance andWithout the guidance and Without the guidance and Without the guidance and Without the guidance and Without the guidance and Without the guidance and Without the guidance and  protection of their professors, Game of Thrones is roughly based on the storylines of A Song of Ice and Fire, set in the fictional Seven Kingdoms of Game of Thrones is roughly based on the storylines of A Song of Ice and Fire, set in the fictional Seven Kingdoms of Harry (Daniel Radcliffe), Ron (Rupert Grint) and Hermione (Emma Watson) begin a mission to destroy the Horcruxes, the sources of Voldemort's immortality. Though they must rely on one another more than ever, dark forces threaten to tear them apart. Voldemort's Death Eaters have seized control of the Ministry of Magic and Hogwarts, and they are searching for Harry -- even as he and his friends prepare for the ultimate showdown.",

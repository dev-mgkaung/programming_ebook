...
class _AddButtonState extends State<AddButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      BlocBuilder<AddToCartBloc, String>(builder: (_, buttontext) {
      ...
      return Padding(
        ...
        child: RaisedButton(
          ...
          elevation: 1.0,
          onPressed: () {
            addToCartBloc.add(cartState ? AddToCartEvent.add : AddToCartEvent.remove);
          },
          child: Row(
            children: <Widget>[
              ...
              Text(buttontext,style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),)
            ],
          ),
